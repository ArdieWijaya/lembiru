...
@section('content')
<div class="container mt-4 d-flex justify-content-between" style="min-height: calc(100vh - 58px)">
    ...
    <div class="col-4 d-flex flex-column justify-content-center">
        ...
        <form action='/kontak/submit' method="post">
            ...
            <div class="form-group row">
                <div class="col">
                    <input style="background-color: #EFF2F4; border-color: #EFF2F4; width: 25vw; height: 3vw; padding: 25px;" placeholder="Nama" id="email" type="text" class="form-control" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                </div>
            </div>
            ...
            <div class="form-group">
                <textarea style="background-color: #EFF2F4; border-color: #EFF2F4; width: 25vw; height: 3vw; padding: 25px; padding-bottom: 200px;" placeholder="Pesan" id="pesan" name="pesan" class="form-control @error('pesan') is-invalid @enderror" rows="3"></textarea>
                @error('pesan')
